            ...
            <Card style={{ width: '400px', borderRadius: '15px' }} className="shadow-sm border-0">
                <Card.Body className="p-5">
                    <div className="text-center mb-4">
                        <h3 className="fw-bold" style={{ color: '#1a233a' }}>FisioReport</h3>
                    ...
                    <div className="text-center">
                        <small className="text-muted">Não tem uma conta? </small>
                        <a href="#" onClick={(e) => { e.preventDefault(); onRegister(); }} className="text-decoration-none small fw-bold">Cadastre-se</a>
                    </div>
                </Card.Body>
            </Card>
        </Container>
